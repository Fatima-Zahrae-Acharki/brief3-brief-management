...
Route::get("/BriefAssign/{id}", [briefController::class, 'displayApprentices']);
Route::get('/BriefAssign/{briefId}/Attach/{id}', [briefController::class, 'attachBrief']);
Route::get('/BriefAssign/{briefId}/Detach/{id}', [briefController::class, 'detachBrief']);


//-------assign to all the promotions------------------------------------------------
Route::get('BriefAssign/{briefId}/AttachClass', [briefController::class, 'assignClass']);